class Deal < ActiveRecord::Base
  ...
  attr_accessible :is_current,:is_active,:contact,:amount, :attempts, :initiated_by, :is_public, 
          ...
          :stage_move_date, :tag_list, :hot_lead_token, :token_expiry_time, :next_priority_id, :assignee_id, :is_remote,:payment_status,:referrer,:visited,:location_by_api, :individual_contact_id, :user_label_id, :priority_type_id, :country_id, :web_form_id
