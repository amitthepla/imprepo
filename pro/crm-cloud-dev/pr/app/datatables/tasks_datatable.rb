...
#    cuser=User.find params[:cuser]
    ...
    tasks.map do |task|
      ...
      [
        ...
        h(deal.contact_name.present? ? deal.contact_name[0].upcase : ""), #row[21]
        h(deal.contact_name.present? ? deal.get_color_code(deal.contact_name.downcase[0]) : ""), #row[22]
        ...
        h(deal.contact_info.present? ? deal.contact_info['id'] : ""), #row[27]
        h(task.get_title_hover), #row[28]
        h(deal.deals_contacts.present? && deal.deals_contacts.first.contactable.present? ? deal.deals_contacts.first.contactable.to_param : ""), #row[29]
        h(deal.deals_contacts.present? && deal.deals_contacts.first.contactable.present? ? deal.deals_contacts.first.contactable.class.name : ""), #row[30]
      ]
    end
  end
