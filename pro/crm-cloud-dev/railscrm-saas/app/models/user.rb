...
class User < ActiveRecord::Base
  ...
  devise :invitable,:database_authenticatable, :registerable,
         :recoverable, :rememberable, :trackable, :validatable, :lockable#, :omniauthable, :omniauth_providers => [:google_oauth2, :linkedin]

  # Setup accessible (or protected) attributes for your model
  attr_accessible :email, :password, :password_confirmation,
                  :remember_me,:admin_type, :time_zone, :task_date,
                  :first_name, :last_name, :work_phone, :role_id, :profile_image, :confirmed_at, :confirmation_token, :is_beta_user,:priority_label,:digest_mail_date, :organization_id, :provider, :uid, :token, :is_blocked, :is_active
