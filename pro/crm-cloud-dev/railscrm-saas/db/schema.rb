...
ActiveRecord::Schema.define(:version => 20170505105447) do
  ...
  create_table "organizations", :force => true do |t|
    ...
    t.boolean  "is_sub_active",         :default => false
    t.integer  "user_allowed_by_admin", :default => 0
  ...
  add_index "transactions", ["user_subscription_id"], :name => "index_transactions_on_user_subscription_id"
  ...
  create_table "user_subscriptions", :force => true do |t|
    ...
    t.datetime "created_at",                                 :null => false
    t.datetime "updated_at",                                 :null => false
    t.boolean  "is_cancel_payment_fail",  :default => false
  end
