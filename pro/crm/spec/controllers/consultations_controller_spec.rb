...
RSpec.describe ConsultationsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested consultation as @consultation" do
      consultation = Consultation.create! valid_attributes
      get :show, params: {id: consultation.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested consultation as @consultation" do
      consultation = Consultation.create! valid_attributes
      get :edit, params: {id: consultation.to_param}, session: valid_session
      expect(assigns(:consultation)).to eq(consultation)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Consultation" do
        expect {
          post :create, params: {consultation: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved consultation as @consultation" do
        post :create, params: {consultation: invalid_attributes}, session: valid_session
        expect(assigns(:consultation)).to be_a_new(Consultation)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested consultation" do
        consultation = Consultation.create! valid_attributes
        put :update, params: {id: consultation.to_param, consultation: new_attributes}, session: valid_session
        consultation.reload
      ...
      it "assigns the requested consultation as @consultation" do
        consultation = Consultation.create! valid_attributes
        put :update, params: {id: consultation.to_param, consultation: valid_attributes}, session: valid_session
        expect(assigns(:consultation)).to eq(consultation)
      end
    ...
    context "with invalid params" do
      it "assigns the consultation as @consultation" do
        consultation = Consultation.create! valid_attributes
        put :update, params: {id: consultation.to_param, consultation: invalid_attributes}, session: valid_session
        expect(assigns(:consultation)).to eq(consultation)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested consultation" do
      consultation = Consultation.create! valid_attributes
      expect {
        delete :destroy, params: {id: consultation.to_param}, session: valid_session
      }.to change(Consultation, :count).by(-1)
    end
